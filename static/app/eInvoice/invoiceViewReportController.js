        ...
        $scope.getInvoice = function(_ID) {
            ...
            eInvoiceService.getInvoice(
                ...
                function(response, status) { //success
                    ...
                    $scope.EditInvoice.InvoiceAdjDescription = "";
                    if (!angular.isUndefinedOrNull($scope.EditInvoice.OriginalInvoiceID)) {
                        ...
                        $scope.EditInvoice.InvoiceAdjDescription += " của hóa đơn số " + $scope.EditInvoice.OriginalInvoiceNo + " ngày " + moment.unix($scope.EditInvoice.OriginalInvoiceDate).format("DD-MM-YYYY") + " ký hiệu " + $scope.EditInvoice.OriginalFormTypeSymbol;
                    } 
