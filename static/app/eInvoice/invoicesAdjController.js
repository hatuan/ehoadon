...
define(['angularAMD', 'jquery', 'ajaxService', 'alertsService', 'select2', 'myApp.Search', 'eInvoiceService', 'digitalsignature', 'reportjs-report', 'reportjs-viewer', 'app/eInvoice/invoiceMaintenanceController', 'app/eInvoice/invoiceViewReportController', 'app/eInvoice/invoiceSendController', 'app/eInvoice/invoiceAdjSelectController'], function (angularAMD, $) {
    var injectParams = ['$scope', '$rootScope', '$state', '$window', 'moment', '$uibModal', '$confirm', 'alertsService', 'Constants', 'eInvoiceService'];

    var eInvoicesAdjController = function ($scope, $rootScope, $state, $window, moment, $uibModal, $confirm, alertsService, Constants, eInvoiceService) {
        ...
        $scope.getInvoices = function () {
            ...
            eInvoiceService.getInvoicesAdj(eInvoicesInquiry, $scope.eInvoicesInquiryCompleted, $scope.eInvoicesInquiryError);
        };
        ...
        $scope.new = function () {
            var modalInstance = $uibModal.open({
                ...
                templateUrl: 'app/eInvoice/invoiceAdjSelect.html',
                controller: 'eInvoiceAdjSelectController',
                resolve: {
                    numberForms: function() {
                        var __numberForms = $.extend({}, $scope.NumberForms);
                        return __numberForms;
                    },
                    symbols: function() {
                        var __symbols = $.extend({}, $scope.Symbols);
                        return __symbols;
                    } 
                }
            });
    ...
    eInvoicesAdjController.$inject = injectParams;
    angularAMD.controller('eInvoicesAdjController', eInvoicesAdjController);
});
